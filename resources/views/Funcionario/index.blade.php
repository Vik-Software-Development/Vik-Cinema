...
@section('view')
    ...
    <a href="{{route('funcionarios.create')}}" class="btn btn-dark botao_table botao">Cadastrar</a>
    <div class="listar">
        <table class="table table-dark">
            ...
            @foreach($funcionarios as $funcionario)
                <tr>
                    ...
                    <td>
                        <a href="{{route('funcionarios.edit',$funcionario->id)}}" class="acao_table">
                        ...
                        <a href="{{route('funcionarios.show',$funcionario->id)}}" class="acao_table">
