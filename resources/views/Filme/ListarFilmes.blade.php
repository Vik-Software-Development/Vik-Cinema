...
@section('view')
	...
	<a href="{{route('filmes.create')}}" class="btn btn-dark botao_table botao">Cadastrar</a>
	<div class="listar">
		<table class="table table-dark">
			...
			@foreach($filmes as $filme)
				<tr>
					...
					<td>{{$filme->duracao}}</td>
					<td>
						<a href="{{route('filmes.edit',$filme->id)}}" class="acao_table">
						...
						<a href="{{route('filmes.show',$filme->id)}}" class="acao_table">
